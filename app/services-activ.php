    ...
    <main>
        <section class="payment-section services__tell">
			<div class="services__header">
				<div class="services__tab">
					...
					<span><span><a href="services-activ.php"><b><?= htmlspecialchars($lang['services_text__mobile-activ']['title']) ?></b></a></span></span>
				</div>
			</div>
        ...
        <section class="services__text">
			<div class="container">
				...
				<h1><?= $lang['services_text__mobile-activ']['title'] ?></h1>
				<p><?= $lang['services_text__mobile-activ']['text'] ?></p>
				</div>
			</div>
		</section>
