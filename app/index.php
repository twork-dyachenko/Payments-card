            ...
            <form class="payment-form" onsubmit="return validateForm(event)" novalidate>
                ...
                <div class="payment-form__container">
                    <div class="payment-form__block payment-form__block--sender">
						...
						<div class="payment-form__row">
                        	<div class="payment-form__wrapper full-width">
								...
								<input type="text" data-type="card-number" class=" payment-form__input" name="senderCard" placeholder="Card number" maxlength="19" required pattern="\d{19}" />
                    ...
                    <div class="payment-form__block payment-form__block--recipient">
                        ...
                        <div class="payment-form__row">
							<div class="payment-form__wrapper full-width">
								<input type="text" data-type="card-number" class="payment-form__input" name="recipientCard" placeholder="Card number" maxlength="19" required pattern="\d{19}" />
								<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"><path stroke="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M3 11v4.8c0 1.12 0 1.68.218 2.108a2 2 0 0 0 .874.874c.427.218.987.218 2.105.218h11.606c1.118 0 1.677 0 2.104-.218.377-.192.683-.498.875-.874.218-.428.218-.986.218-2.104V11M3 11V9m0 2h18M3 9v-.8c0-1.12 0-1.68.218-2.108.192-.377.497-.682.874-.874C4.52 5 5.08 5 6.2 5h11.6c1.12 0 1.68 0 2.107.218.377.192.683.497.875.874.218.427.218.987.218 2.105V9M3 9h18M7 15h4m10-4V9"/></svg>
							</div>
							<div class="payment-form__wrapper full-width">
								<input 
						...
						<div class="payment-form__row">
							...
							<div class="payment-form__wrapper full-width">
								<span class="payment-form__limit">From 150 to <br> 500000 KZT of money</span>
							</div>
						</div>
				...
				<div class="payment-form__container">
					<div class="payment-form__summary">
						...
						<div class="payment-form__total">
							<p>To pay</p> <strong id="totalToPay">0,00 </strong><span>KZT</span></p>
						</div>
						...
						<div class="payment-form__note">
							...
							the Public Agreement for the provision of payment services.
						</div>
					</div>
				</div>
            </form>
		...
		<section class="services__text">
            <div class="container">
                <div class="services__text-item">
                    ...
                    <p>Первой услугой, которую мы в Pay+ запустили на своем сайте – это денежные переводы с карты на карту. Переводы – одна из фишек нашего платежного инструмента, а потому мы можем выполнять <b>онлайн перевод денег</b> быстро и удобно. Вам не нужно знать все реквизиты получателя: достаточно <b>перевести деньги по номеру карты.</b> Благодаря нашему решению <b>перевод с карты на карту в Казахстане</b> занимает всего несколько секунд и доступен круглосуточно. Поддерживаются <b>денежные переводы между банками,</b> независимо от того, в каком банке открыт счёт. Безопасность операций гарантирована — используйте Pay+ для простых и надежных переводов в любой точке страны.
