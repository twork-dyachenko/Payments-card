<?php 
	...
	include("header.php");
?>
<title>Services tele2 ENG</title>
    ...
    <main>
        <section class="payment-section services__tell">
			<div class="services__header">
				<div class="services__tab">
					...
					<span><span><a href="services-tele2.php"><b><?= htmlspecialchars($lang['services_text__mobile-tele2']['title']) ?></b></a></span></span>
				</div>
			</div>
        ...
        <section class="services__text">
			<div class="container">
				...
				<h1><?= $lang['services_text__mobile-tele2']['title'] ?></h1>
				<p><?= $lang['services_text__mobile-tele2']['text'] ?></p>
				</div>
			</div>
		</section>
