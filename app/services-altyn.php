<?php 
	...
	include("header.php");
?>
<title>Services AltynCoin</title>
        ...
        <section class="payment-section services__tell">
			<div class="services__header">
                <div class="services__tab">
                    ...
                    <span><a href="services-fin.php"><?= htmlspecialchars($lang['services_tab']['finance']) ?></a></span>
                    <svg width="5" height="8" viewBox="0 0 5 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M1 1L4 4L1 7" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                    <span><span><a href="services-fin--mfo.php"><?= htmlspecialchars($lang['services_tab']['title']) ?></a></span></span>
                    <svg width="5" height="8" viewBox="0 0 5 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M1 1L4 4L1 7" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                    <span><span><a href="services-steam.php"><b><?= htmlspecialchars($lang['finance_text__altyncoin']['title']) ?></b></a></span></span>
                </div>
			</div>
        ...
        <section class="services__text">
            <div class="container">
                <div class="services__text-item">
                    <h1><?= $lang['finance_text__altyncoin']['title'] ?></h1>
                    <p><?= $lang['finance_text__altyncoin']['text'] ?></p>
                </div>
            </div>
        </section>
